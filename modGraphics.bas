...
Private Sub SpecialFrames() 'update frames for special things such as coins and kuribo's shoe
    ...
    If SpecialFrameCount(1) >= 6 Then
        SpecialFrame(1) = SpecialFrame(1) + 1
        If SpecialFrame(1) >= 2 Then SpecialFrame(1) = 0
        SpecialFrameCount(1) = 0
    End If
    SpecialFrameCount(2) = SpecialFrameCount(2) + 1
    If SpecialFrameCount(2) >= 3 Then
        SpecialFrame(2) = SpecialFrame(2) + 1
        If SpecialFrame(2) >= 4 Then SpecialFrame(2) = 0
        SpecialFrameCount(2) = 0
    End If
    SpecialFrameCount(3) = SpecialFrameCount(3) + 1
    If SpecialFrameCount(3) >= 8 Then
        SpecialFrame(3) = SpecialFrame(3) + 1
        If SpecialFrame(3) >= 4 Then SpecialFrame(3) = 0
        SpecialFrameCount(3) = 0
    End If
    SpecialFrameCount(4) = SpecialFrameCount(4) + 1
    If SpecialFrameCount(4) >= 2.475 Then
        SpecialFrame(4) = SpecialFrame(4) + 1
        If SpecialFrame(4) >= 4 Then SpecialFrame(4) = 0
        SpecialFrameCount(4) = SpecialFrameCount(4) - 2.475
    End If
    SpecialFrameCount(5) = SpecialFrameCount(5) + 1
    If SpecialFrameCount(5) < 20 Then
        SpecialFrame(5) = 1
    ElseIf SpecialFrameCount(5) < 25 Then
        SpecialFrame(5) = 2
    ElseIf SpecialFrameCount(5) < 30 Then
        SpecialFrame(5) = 3
    ElseIf SpecialFrameCount(5) < 35 Then
        SpecialFrame(5) = 4
    ElseIf SpecialFrameCount(5) < 40 Then
        SpecialFrame(5) = 5
    ElseIf SpecialFrameCount(5) < 45 Then
        SpecialFrame(5) = 1
    ElseIf SpecialFrameCount(5) < 50 Then
        SpecialFrame(5) = 0
    Else
        SpecialFrameCount(5) = 0
    End If
    SpecialFrameCount(6) = SpecialFrameCount(6) + 1
    If SpecialFrameCount(6) >= 12 Then
        SpecialFrame(6) = SpecialFrame(6) + 1
        If SpecialFrame(6) >= 4 Then SpecialFrame(6) = 0
        SpecialFrameCount(6) = 0
    End If
    SpecialFrameCount(7) = SpecialFrameCount(7) + 1
    If SpecialFrameCount(7) < 8 Then
        SpecialFrame(7) = 0
    ElseIf SpecialFrameCount(7) < 16 Then
        SpecialFrame(7) = 1
    ElseIf SpecialFrameCount(7) < 24 Then
        SpecialFrame(7) = 2
    ElseIf SpecialFrameCount(7) < 32 Then
        SpecialFrame(7) = 3
    ElseIf SpecialFrameCount(7) < 40 Then
        SpecialFrame(7) = 2
    ElseIf SpecialFrameCount(7) < 48 Then
        SpecialFrame(7) = 1
    Else
        SpecialFrameCount(7) = 0
    End If
    SpecialFrameCount(8) = SpecialFrameCount(8) + 1
    If SpecialFrameCount(8) >= 8 Then
    ...
    If SpecialFrameCount(9) >= 8 Then
        ...
        If SpecialFrame(9) >= 2 Then SpecialFrame(9) = 0
...
Public Sub DrawBackground(S As Integer, Z As Integer) 'draws the background to the screen
    ...
    tempLevel = level(S)
    If LevelEditor = True Then LevelREAL(S) = level(S)
    level(S) = LevelREAL(S)
    A = 1 'Blocks
    If Background2(S) = 1 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                ...
                .Y = level(S).Height - GFXBackground2Height(A)
                .Height = GFXBackground2Height(A)
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A), GFXBackground2(A), 0, 0, vbSrcCopy
            End With
        Next B
    End If
    A = 2 'Clouds
    If Background2(S) = 1 Or Background2(S) = 2 Or Background2(S) = 22 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                .Y = level(S).Height - GFXBackground2Height(A) - ScreenH + 100
                .Height = GFXBackground2Height(A)
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A), GFXBackground2(A), 0, 0, vbSrcCopy
            End With
    ...
    End If
    A = 4 'Castle
    If Background2(S) = 3 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 2
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
                    '.Y = (-vScreenY(Z) - level(S).Y) / (level(S).Height - level(S).Y - 600) * (GFXBackground2Height(A) - 600)
    ...
    End If
    A = 5 'Pipes
    If Background2(S) = 4 Then
        For B = 0 To Int((level(S).Height - level(S).Y) / GFXBackground2Height(A) * 0.5) + 1
            With tempLocation
                .Y = level(S).Y + ((B * GFXBackground2Height(A) - B) - (vScreenY(Z) + vScreen(Z).Top + level(S).Y) * 0.5) - 32
                If level(S).Width - level(S).X > GFXBackground2Width(A) Then
                    .X = (-vScreenX(Z) - level(S).X) / (level(S).Width - level(S).X - (800 - vScreen(Z).Left)) * (GFXBackground2Width(A) - (800 - vScreen(Z).Left))
                    .X = -vScreenX(Z) - .X
                Else
                    .X = level(S).Width - GFXBackground2Width(A)
                End If
                .Height = GFXBackground2Height(A)
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A), GFXBackground2(A), 0, 0, vbSrcCopy
    ...
    End If
    A = 9 'Night
    If Background2(S) = 8 Or Background2(S) = 9 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
        ...
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                ...
                If level(S).Height - level(S).Y > GFXBackground2Height(A) / 4 Then
                    ...
                    .Y = -vScreenY(Z) - .Y
                Else
                    .Y = level(S).Height - GFXBackground2Height(A) / 4
                End If
    ...
    If Background2(S) = 24 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                .Y = level(S).Y - 32 'Height - GFXBackground2height(a)
                .Height = GFXBackground2Height(A)
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A), GFXBackground2(A), 0, 0, vbSrcCopy
            End With
    ...
    End If
    A = 28 'SMW Bonus
    If Background2(S) = 28 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 3
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
                    '.Y = (-vScreenY(Z) - level(S).Y) / (level(S).Height - level(S).Y - 600) * (GFXBackground2Height(A) - 600)
    ...
    If Background2(S) = 29 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                ...
                .Height = GFXBackground2Height(A) / 4
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A) / 4, GFXBackground2(A), 0, (GFXBackground2Height(A) / 4) * SpecialFrame(6), vbSrcCopy
            End With
        Next B
    End If
    A = 30 'SMW Cave
    If Background2(S) = 30 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) / 4 Then
    ...
    End If
    A = 36 'Snow Clouds
    If Background2(S) = 35 Or Background2(S) = 37 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                .Y = level(S).Height - GFXBackground2Height(A) - ScreenH + 100
    ...
    If Background2(S) = 38 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                .Y = level(S).Y - 20 'Height - GFXBackground2height(a)
                .Height = GFXBackground2Height(A)
                .Width = GFXBackground2Width(A)
                If vScreenCollision(Z, tempLocation) Then BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), GFXBackground2Height(A), GFXBackground2(A), 0, 0, vbSrcCopy
            End With
    ...
    If Background2(S) = 40 Then
        With tempLocation
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 953, GFXBackground2Width(A), 47, GFXBackground2(A), 0, 953, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.6) + 1
                ...
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 916, GFXBackground2Width(A), 37, GFXBackground2(A), 0, 916, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.7) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.7)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 849, GFXBackground2Width(A), 67, GFXBackground2(A), 0, 849, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.8) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.8)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 815, GFXBackground2Width(A), 34, GFXBackground2(A), 0, 815, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.9) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.9)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 709, GFXBackground2Width(A), 106, GFXBackground2(A), 0, 709, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.85) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.85)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 664, GFXBackground2Width(A), 45, GFXBackground2(A), 0, 664, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.8) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.8)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 614, GFXBackground2Width(A), 50, GFXBackground2(A), 0, 614, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 540, GFXBackground2Width(A), 74, GFXBackground2(A), 0, 540, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.7) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.7)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 408, GFXBackground2Width(A), 132, GFXBackground2(A), 0, 408, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 333, GFXBackground2Width(A), 75, GFXBackground2(A), 0, 333, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.8) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.8)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 278, GFXBackground2Width(A), 55, GFXBackground2(A), 0, 278, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.85) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.85)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 235, GFXBackground2Width(A), 43, GFXBackground2(A), 0, 235, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.9) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.9)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 123, GFXBackground2Width(A), 112, GFXBackground2(A), 0, 123, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.8) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.8)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 85, GFXBackground2Width(A), 38, GFXBackground2(A), 0, 85, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.7) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.7)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 48, GFXBackground2Width(A), 37, GFXBackground2(A), 0, 48, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.6) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.6)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), 48, GFXBackground2(A), 0, 0, vbSrcCopy
                End If
            Next B
        End With
    End If
    A = 41 'SMB 1 Castle
    If Background2(S) = 41 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 2
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
    ...
    If Background2(S) = 49 Then
        With tempLocation
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 280, GFXBackground2Width(A), 450, GFXBackground2(A), 0, 280, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.9) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.9)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 268, GFXBackground2Width(A), 12, GFXBackground2(A), 0, 268, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.89) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.89)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 244, GFXBackground2Width(A), 24, GFXBackground2(A), 0, 244, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.88) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.88)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 228, GFXBackground2Width(A), 16, GFXBackground2(A), 0, 228, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.87) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.87)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 196, GFXBackground2Width(A), 32, GFXBackground2(A), 0, 196, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.86) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.86)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 164, GFXBackground2Width(A), 32, GFXBackground2(A), 0, 164, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.85) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.85)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 116, GFXBackground2Width(A), 48, GFXBackground2(A), 0, 116, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.84) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.84)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 58, GFXBackground2Width(A), 58, GFXBackground2(A), 0, 58, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.83) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.83)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), 58, GFXBackground2(A), 0, 0, vbSrcCopy
                End If
            Next B
        End With
    End If
    A = 50 'Shrooms
    If Background2(S) = 50 Then
        With tempLocation
            If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
                '.Y = (-vScreenY(Z) - level(S).Y) / (level(S).Height - level(S).Y - 600) * (GFXBackground2Height(A) - 600)
                .Y = (-vScreenY(Z) - vScreen(Z).Top - level(S).Y) / (level(S).Height - level(S).Y - ScreenH) * (GFXBackground2Height(A) - ScreenH) + vScreen(Z).Top
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 378, GFXBackground2Width(A), 378, GFXBackground2(A), 0, 378, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.65) + 1
                ...
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), 220, GFXBackground2(A), 0, 0, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.6) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.6)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 220, GFXBackground2Width(A), 159, GFXBackground2(A), 0, 220, vbSrcCopy
                End If
            Next B
        End With
    End If
    ...
    If Background2(S) = 51 Then
        With tempLocation
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.75) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.75)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y, GFXBackground2Width(A), 350, GFXBackground2(A), 0, 0, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 350, GFXBackground2Width(A), GFXBackground2Height(A) - 350, GFXBackground2(A), 0, 350, vbSrcCopy
                End If
            Next B
        End With
    End If
    A = 52 'SMB2 Desert Night
    If Background2(S) = 52 Then
        With tempLocation
            If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
                '.Y = (-vScreenY(Z) - level(S).Y) / (level(S).Height - level(S).Y - 600) * (GFXBackground2Height(A) - 600)
                .Y = (-vScreenY(Z) - vScreen(Z).Top - level(S).Y) / (level(S).Height - level(S).Y - ScreenH) * (GFXBackground2Height(A) - ScreenH) + vScreen(Z).Top
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 280, GFXBackground2Width(A), GFXBackground2Height(A) - 280, GFXBackground2(A), 0, 280, vbSrcCopy
                End If
            Next B
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.9) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.9)
    ...
    If Background2(S) = 56 Then
        With tempLocation
            ...
            For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 1
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If vScreenCollision(Z, tempLocation) Then
                    BitBlt myBackBuffer, vScreenX(Z) + .X, vScreenY(Z) + .Y + 455, GFXBackground2Width(A), GFXBackground2Height(A) - 455, GFXBackground2(A), 0, 455, vbSrcCopy
                End If
            Next B
        End With
    End If
    A = 57 'Warehouse
    If Background2(S) = 57 Then
        For B = 0 To Int((level(S).Width - level(S).X) / GFXBackground2Width(A) * 0.5) + 2
            With tempLocation
                .X = level(S).X + ((B * GFXBackground2Width(A)) - (vScreenX(Z) + vScreen(Z).Left + level(S).X) * 0.5)
                If level(S).Height - level(S).Y > GFXBackground2Height(A) Then
...
Public Sub PlayerWarpGFX(A As Integer, tempLocation As Location, X2 As Single, Y2 As Single)
    With Player(A)
        ...
        '.Effect2 = 3     -- Done
        If .Effect2 = 0 Then
            If Warp(.Warp).Direction = 3 Then 'Moving down
                If tempLocation.Height > (Warp(.Warp).Entrance.Y + Warp(.Warp).Entrance.Height) - (tempLocation.Y) Then
                    tempLocation.Height = (Warp(.Warp).Entrance.Y + Warp(.Warp).Entrance.Height) - (tempLocation.Y)
                End If
            ElseIf Warp(.Warp).Direction = 1 Then 'Moving up
                If Warp(.Warp).Entrance.Y > tempLocation.Y Then
                    Y2 = (Warp(.Warp).Entrance.Y - tempLocation.Y)
                    tempLocation.Y = Warp(.Warp).Entrance.Y
                    tempLocation.Height = tempLocation.Height - Y2
                End If
            ElseIf Warp(.Warp).Direction = 4 Then 'Moving right
                tempLocation.Width = (Warp(.Warp).Entrance.X + Warp(.Warp).Entrance.Width) - (tempLocation.X)
            ElseIf Warp(.Warp).Direction = 2 Then 'Moving left
                X2 = (Warp(.Warp).Entrance.X - tempLocation.X)
                If X2 < 0 Then
                    X2 = 0
                Else
                    tempLocation.X = Warp(.Warp).Entrance.X
                End If
            End If
        ElseIf .Effect2 = 2 Then
            If Warp(.Warp).Direction2 = 3 Then 'Moving up
                If tempLocation.Height > (Warp(.Warp).Exit.Y + Warp(.Warp).Exit.Height) - (tempLocation.Y) Then
                    tempLocation.Height = (Warp(.Warp).Exit.Y + Warp(.Warp).Exit.Height) - (tempLocation.Y)
                End If
            ElseIf Warp(.Warp).Direction2 = 1 Then 'Moving down
                If Warp(.Warp).Exit.Y > tempLocation.Y Then
                    Y2 = (Warp(.Warp).Exit.Y - tempLocation.Y)
                    tempLocation.Y = Warp(.Warp).Exit.Y
                    tempLocation.Height = tempLocation.Height - Y2
                End If
            ElseIf Warp(.Warp).Direction2 = 4 Then 'Moving left
                tempLocation.Width = (Warp(.Warp).Exit.X + Warp(.Warp).Exit.Width) - (tempLocation.X)
            ElseIf Warp(.Warp).Direction2 = 2 Then 'Moving right
                X2 = (Warp(.Warp).Exit.X - tempLocation.X)
                If X2 < 0 Then
                    X2 = 0
                Else
                    tempLocation.X = Warp(.Warp).Exit.X
                End If
            End If
        End If
        If .Effect2 = 1 Or .Effect2 >= 100 Then tempLocation.Height = 0
        If tempLocation.Height < 0 Then
...
Public Sub NPCWarpGFX(A As Integer, tempLocation As Location, X2 As Single, Y2 As Single)
    With NPC(Player(A).HoldingNPC)
        ...
        If Player(A).Effect2 = 0 Then
            If Warp(Player(A).Warp).Direction = 3 Then 'Moving down
                If tempLocation.Height > (Warp(Player(A).Warp).Entrance.Y + Warp(Player(A).Warp).Entrance.Height) - (tempLocation.Y) Then
                    tempLocation.Height = (Warp(Player(A).Warp).Entrance.Y + Warp(Player(A).Warp).Entrance.Height) - (tempLocation.Y)
                End If
            ElseIf Warp(Player(A).Warp).Direction = 1 Then 'Moving up
                If Warp(Player(A).Warp).Entrance.Y > tempLocation.Y Then
                    Y2 = (Warp(Player(A).Warp).Entrance.Y - tempLocation.Y)
                    tempLocation.Y = Warp(Player(A).Warp).Entrance.Y
                    tempLocation.Height = tempLocation.Height - Y2
                End If
            ElseIf Warp(Player(A).Warp).Direction = 4 Then 'Moving right
                tempLocation.Width = (Warp(Player(A).Warp).Entrance.X + Warp(Player(A).Warp).Entrance.Width) - (tempLocation.X)
            ElseIf Warp(Player(A).Warp).Direction = 2 Then 'Moving left
                ...
                End If
            End If
        ElseIf Player(A).Effect2 = 2 Then
            If Warp(Player(A).Warp).Direction2 = 3 Then 'Moving up
                If tempLocation.Height > (Warp(Player(A).Warp).Exit.Y + Warp(Player(A).Warp).Exit.Height) - (tempLocation.Y) Then
                    tempLocation.Height = (Warp(Player(A).Warp).Exit.Y + Warp(Player(A).Warp).Exit.Height) - (tempLocation.Y)
                End If
            ElseIf Warp(Player(A).Warp).Direction2 = 1 Then 'Moving down
                If Warp(Player(A).Warp).Exit.Y > tempLocation.Y Then
                    Y2 = (Warp(Player(A).Warp).Exit.Y - tempLocation.Y)
                    tempLocation.Y = Warp(Player(A).Warp).Exit.Y
                    tempLocation.Height = tempLocation.Height - Y2
                End If
            ElseIf Warp(Player(A).Warp).Direction2 = 4 Then 'Moving left
                tempLocation.Width = (Warp(Player(A).Warp).Exit.X + Warp(Player(A).Warp).Exit.Width) - (tempLocation.X)
            ElseIf Warp(Player(A).Warp).Direction2 = 2 Then 'Moving right
            ...
            End If
        End If
        If Player(A).Effect2 = 1 Or Player(A).Effect2 >= 100 Then tempLocation.Height = 0
        If tempLocation.Height < 0 Then
            tempLocation.Height = 0
            tempLocation.Width = 0
        End If
